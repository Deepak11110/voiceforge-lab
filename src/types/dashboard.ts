...
export type DashboardContextType = {
  ...
  closeDetails: () => void;
  handleVoiceCreated: (creatorId?: string) => Promise<Voice | null>;
  ...
  addCreator: (creatorData: { name: string; email: string; }) => Creator;
  createTeam: (teamData: { name: string; description?: string; members: string[]; }) => Team;
